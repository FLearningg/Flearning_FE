    ...
    <>
      <div className="amc-breadcrumb">
        <div className="amc-breadcrumb-content">
          <span>Course</span> / <span>My Course</span> / <span>Development</span> / <span>Web Development</span> /
            ...
            <div className="amc-card">
              <div className="amc-card-content">
                <div className="amc-course-info">
                  <img src="https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=320&h=192&fit=crop" alt="Course thumbnail" className="amc-course-image" />
                  <div className="amc-course-details">
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "16px" }}>
                      <div>
                        <p className="amc-course-meta">Uploaded: Jan 21, 2020 • Last Updated: Sep 11, 2021</p>
                        <h2 className="amc-course-title">2021 Complete Python Bootcamp From Zero to Hero in Python</h2>
                        <p className="amc-course-description">3 in 1 Course: Learn to design websites with Figma, build with Webflow, and make a living freelancing.</p>
                      </div>
                    ...
                    <div className="amc-course-creators-rating">
                      ...
                      <div className="amc-rating">
                        {[...Array(5)].map((_, i) => (<StarIcon key={i} filled={i < 4} className="amc-star" />))}
                        <span className="amc-rating-text">4.8</span>
                        <span className="amc-rating-count">(451,444 Ratings)</span>
                      </div>
                    </div>
                    <div className="amc-course-pricing">
                      <div className="amc-price-item"><h3>$13.99</h3><p>Course prices</p></div>
              ...
              <div className="amc-rating-content">
                <div className="amc-rating-summary-new">
                  <div className="amc-rating-summary-box">
                    <div className="amc-rating-number-large">4.8</div>
                    <div className="amc-rating-stars-large">
                      {[...Array(5)].map((_, i) => (<StarIcon key={i} filled={i < 5} className="amc-star" />))}
                    </div>
