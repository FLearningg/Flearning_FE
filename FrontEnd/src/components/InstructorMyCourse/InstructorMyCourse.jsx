...
function InstructorMyCourse() {
  ...
  const handleEdit = () => {
    setShowDropdown(false);
    navigate(`/instructor/courses/edit/${id}`, { state: { courseData } });
  };
                    ...
                    >
                      <div className="amc-trailer-overlay">
                        ...
                        <div className="amc-trailer-text">
                          <h4>Add Course Trailer</h4>
                          <p>Click to add a trailer to showcase your course</p>
                        </div>
                      </div>
                      <img
                        src={courseImage}
