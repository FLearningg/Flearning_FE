...
function RecentlyAddedCourse() {
    ...
    const coursesInfo1 = useSelector((state) => state.courses.recentlyAdded.recentlyCourses);
    const isLoading = useSelector((state) => state.courses.recentlyAdded.isLoading);
    useEffect(() => {
    ...
    return (
        <>
            <div className="container my-5">
                ...
                <Link to={'/category'} className='d-flex justify-content-center mt-4 text-decoration-none'>
