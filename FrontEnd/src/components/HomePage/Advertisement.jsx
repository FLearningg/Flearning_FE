        ...
        <>
            <div className="container-fluid desktop-homepage-view">
                <div className="row">
                    <div className="col-6">
                        <div
                            className="h-100 d-flex flex-column justify-content-center align-items-start advertisement-text-container">
                            ...
                            <Link to="#" className="btn-create-account"><button className="">Create account</button></Link>
                        </div>
                    </div>
                    <div className="col-6 pe-0">
                        <img src="/images/advertiment.jpg" alt="" className="w-100 img-cut-corner" />
                    </div>
                </div>
            </div>
                ...
                <div className="content pt-5 text-center">
                    <div className="intro-text">
                        ...
                        <p className="h6 text-start fw-light ">
                            Our mision is to help people to find the best course
