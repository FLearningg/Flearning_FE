...
const bgColors = [
    '#f0f0ff', '#d0f0c0', '#ffe0b2', '#ffcccb', '#f0f8ff', '#f5f5f5',
    '#fff3e0', '#e0f7fa', '#fce4ec', '#f3e5f5', '#e8f5e9', '#fffde7'
];
const iconColors = [
    '#6366f1', '#4caf50', '#ff9800', '#ef4444', '#ff7f50', '#9e9e9e',
    '#ffb300', '#00bcd4', '#d81b60', '#ab47bc', '#43a047', '#fbc02d'
];
...
function TopCategory() {
    const categoryData1 = useSelector((state) => state.categories.getCategories.categories);
    const isLoadding = useSelector((state) => state.categories.getCategories.isLoading);
        ...
        <>
            <div className="container py-5">
                ...
                <div className="text-center mt-5">
                    ...
                    <Link to="/category" className="browse-all text-decoration-none">Browse All <FontAwesomeIcon icon={faArrowRight} /></Link>
                </div>
            </div >
        </>
    )
