                        ...
                        <div className="col-md-8">
                            <div className="row">
                                <div className="col-4 d-flex flex-column align-items-start">
                                    <span style={{ fontSize: '2rem', fontWeight: 700 }}>6.3k</span>
                                    <span className="text-secondary" style={{ fontSize: '1.1rem' }}>Online courses</span>
                                </div>
                                <div className="col-4 d-flex flex-column align-items-start">
                                    <span style={{ fontSize: '2rem', fontWeight: 700 }}>26k</span>
                                    <span className="text-secondary" style={{ fontSize: '1.1rem' }}>Certified Instructor</span>
                                </div>
                                <div className="col-4 d-flex flex-column align-items-start">
                                    <span style={{ fontSize: '2rem', fontWeight: 700 }}>99.9%</span>
                                    <span className="text-secondary" style={{ fontSize: '1.1rem' }}>Success Rate</span>
                                </div>
                            </div>
                        </div>
                    </div>
