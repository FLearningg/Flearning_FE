    ...
    tooltip: {
      ...
      callbacks: {
        ...
        afterBody: (context) => {
           ...
           return dateLabel.includes("Aug") ? dateLabel.replace("Aug ", "") + " Aug" : dateLabel;
        }
      },
    },
  },
...
const withdrawHistory = [
    ...
    { date: "21 Sep, 2021 at 2:14 AM", method: "Visa", amount: "American Express", status: "Cancelled"},
    { date: "21 Sep, 2021 at 2:14 AM", method: "Mastercards", amount: "American Express", status: "Completed"},
    { date: "21 Sep, 2021 at 2:14 AM", method: "Mastercards", amount: "American Express", status: "Completed"},
];
...
const getStatusClass = (status) => {
  switch (status) {
    case "Pending": return "ae-status-pending";
    case "Completed": return "ae-status-completed";
    case "Cancelled": return "ae-status-cancelled";
    default: return "ae-status-badge";
  }
};
    ...
    <div className="ae-dashboard">
      <div className="ae-main-content">
        ...
        <div className="ae-stats-grid">
          <StatCard icon={<DollarSignIcon color="#ff6636" />} amount="$13,804.00" label="Total Revenue" iconBg="orange" />
          <StatCard icon={<MessageSquareIcon color="#564ffd" />} amount="$16,593.00" label="Current Balance" iconBg="purple" />
          <StatCard icon={<CreditCardIcon color="#e34444" />} amount="$13,184.00" label="Total Withdrawals" iconBg="red" />
          <StatCard icon={<ShoppingBagIcon color="#23bd33" />} amount="$162.00" label="Today Revenue" iconBg="green" />
        </div>
          ...
          <div className="ae-cards-section">
            ...
            <div className="ae-cards-content">
              ...
              <div className="ae-card-navigation">
                <button className="ae-nav-arrow"><ArrowLeftIcon /></button>
                <button className="ae-nav-arrow"><ArrowRightIcon /></button>
              </div>
                 ...
                 <div className="ae-payment-info">
                   ...
                   <div className="ae-payment-check">
                     <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
                       <path d="M20 6L9 17L4 12" stroke="#23bd33" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                     </svg>
                   </div>
                 </div>
               </div>
                <div className="ae-payment-option">
                    <div className="ae-payment-info">
                        <div className="ae-payment-logo ae-mastercard">
                            <div style={{ width: "16px", height: "16px", borderRadius: "50%", backgroundColor: "#e6a540", border: "2px solid #e34444", opacity: 0.8, }}></div>
                        </div>
                        <div className="ae-payment-details">
                            <span>2855 **** **** ****</span>
                            <span className="ae-expiry">04/24</span>
                  ...
                  {withdrawHistory.map((item, index) => (
                    <tr key={index}>
                      ...
                      <td style={{ textAlign: "right", position: "relative" }}>
                        <button className="ae-more-btn"
                          onClick={() => {
                            if (item.status === "Pending") setActiveCancelIndex(index);
                            else setActiveCancelIndex(null);
                          }}
                        >
                          <MoreHorizontalIcon />
                        </button>
                        {activeCancelIndex === index && item.status === "Pending" && (
                          <div className="ae-cancel-popup" ref={popupRef} style={{ right: 0, top: 30, position: "absolute" }}>
                            <button className="ae-cancel-btn"
