    ...
    async (error) => {
        ...
        if (error.response?.status === 401 && !originalRequest._retry) {
            ...
            try {
                ...
                // Lưu token mới và thử lại request ban đầu
                ...
                // Nếu việc refresh token cũng thất bại
                console.log("Refresh Token cũng đã hết hạn hoặc không hợp lệ. Đang đăng xuất người dùng...");
                
                // Dispatch action logout của Redux
