...
import { Form, Input, Button, Checkbox, Typography, Row, Col, Divider, Space, message } from 'antd';
      ...
      <Col xs={24} md={14} lg={12} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '40px 60px' }}>
        <div style={{ width: '100%', maxWidth: '480px' }}>
          ...
          <Form name="signup_form" onFinish={onFinish} layout="vertical" size="large">
            ...
            <Form.Item name="password" label={<Text style={{fontWeight: 500, color: '#595959' }}>Password</Text>} rules={[{ required: true, message: 'Vui lòng nhập mật khẩu!' }]} hasFeedback style={{ marginBottom: '16px' }}>
            ...
            <Form.Item style={{ marginBottom: '24px' }}>
              <Button type="primary" htmlType="submit" block loading={isLoading} style={{ backgroundColor: F_LEARNING_ORANGE, borderColor: F_LEARNING_ORANGE, height: '48px', fontSize: '16px', fontWeight: 'bold' }} icon={<ArrowRightOutlined />} iconPosition="end">Create Account</Button>
            </Form.Item>
