  ...
  const handleResendLink = async () => {
    ...
    try {
      ...
      setApiAlert({
        show: true,
        type: "danger",
        message: error.response?.data?.message || "Gửi lại link thất bại.",
      });
    ...
    <Row style={{ minHeight: "100vh", backgroundColor: "#fff" }}>
      ...
      >
        <div style={{ width: "100%", maxWidth: "450px" }}>
          ...
          {apiAlert.show && (
            <div
              className={`alert alert-${apiAlert.type} alert-dismissible fade show`}
              role="alert"
              style={{ marginBottom: "24px" }}
            >
              {apiAlert.message}
              <button
                type="button"
                className="btn-close"
                onClick={() => setApiAlert({ show: false })}
                aria-label="Close"
              ></button>
            </div>
          )}
          ...
          >
            <Form.Item
              name="email"
              label={
                <Text style={{ fontWeight: 500, color: "#595959" }}>Email</Text>
              }
              rules={[
            ...
            <Form.Item style={{ marginBottom: "24px" }}>
              ...
              <Link
                to="/forgot-password"
                style={{ float: "right", color: F_LEARNING_ORANGE }}
              >
                Forgot password?
              </Link>
            </Form.Item>
            ...
            <div style={{ textAlign: "center", marginBottom: "24px" }}>
              ...
              <Link
                to="/signup"
                style={{ color: F_LEARNING_ORANGE, fontWeight: "bold" }}
              >
                Create Account
              </Link>
            </div>
